...
export const DRV_DEFENSE_COVER_HEADER_DE = 'Statusfeststellungsverfahren nach § 7a SGB IV — Defensivdokumentation';
...
export const DRV_DEFENSE_ATTESTATION_FOOTER_DE = 'Datum: __________________   Unterschrift: __________________';
export const DRV_DEFENSE_CROSS_REFERENCE_FOOTER_DE = 'Diese Übersicht zeigt nur Engagements, die von Ihrer Organisation auf dieser Plattform ' +
    'erfasst wurden. Sie ist nicht erschöpfend.';
// --- Phase 63 additions (D-22) — Skonto description template ----------------
export const SKONTO_DESCRIPTION_TEMPLATE_DE = '{percent}% Skonto bei Zahlung innerhalb von {discountDays} Tagen, sonst netto {netDays} Tage';
...
export const EINVOICE_INTAKE_EXTENDED_BEST_EFFORT_DE = 'Diese Rechnung verwendet das EXTENDED-ZUGFeRD-Profil. Einige absenderspezifische Felder konnten nicht zugeordnet werden. Prüfen Sie die Daten sorgfältig vor der Übernahme.';
