...
export const HANDELSREGISTER_COURTS: readonly HandelsregisterCourt[] = [
  ...
  { code: 'amtsgericht-freiburg',          name: 'Amtsgericht Freiburg',          state: 'BW', city: 'Freiburg im Breisgau' },
  ...
  { code: 'amtsgericht-regensburg',        name: 'Amtsgericht Regensburg',        state: 'BY', city: 'Regensburg' },
  { code: 'amtsgericht-wuerzburg',         name: 'Amtsgericht Würzburg',          state: 'BY', city: 'Würzburg' },
  { code: 'amtsgericht-ingolstadt',        name: 'Amtsgericht Ingolstadt',        state: 'BY', city: 'Ingolstadt' },
  ...
  { code: 'amtsgericht-charlottenburg',    name: 'Amtsgericht Charlottenburg',    state: 'BE', city: 'Berlin' },

  // Brandenburg (4 Registergerichte)
  { code: 'amtsgericht-cottbus',           name: 'Amtsgericht Cottbus',           state: 'BB', city: 'Cottbus' },
  { code: 'amtsgericht-frankfurt-oder',    name: 'Amtsgericht Frankfurt (Oder)',  state: 'BB', city: 'Frankfurt (Oder)' },
  ...
  { code: 'amtsgericht-neubrandenburg',    name: 'Amtsgericht Neubrandenburg',    state: 'MV', city: 'Neubrandenburg' },
  ...
  { code: 'amtsgericht-braunschweig',      name: 'Amtsgericht Braunschweig',      state: 'NI', city: 'Braunschweig' },
  ...
  { code: 'amtsgericht-hildesheim',        name: 'Amtsgericht Hildesheim',        state: 'NI', city: 'Hildesheim' },
  ...
  { code: 'amtsgericht-stadthagen',        name: 'Amtsgericht Stadthagen',        state: 'NI', city: 'Stadthagen' },
  ...
  { code: 'amtsgericht-bad-oeynhausen',    name: 'Amtsgericht Bad Oeynhausen',    state: 'NW', city: 'Bad Oeynhausen' },
  ...
  { code: 'amtsgericht-duesseldorf',       name: 'Amtsgericht Düsseldorf',        state: 'NW', city: 'Düsseldorf' },
  { code: 'amtsgericht-essen',             name: 'Amtsgericht Essen',             state: 'NW', city: 'Essen' },
  { code: 'amtsgericht-gelsenkirchen',     name: 'Amtsgericht Gelsenkirchen',     state: 'NW', city: 'Gelsenkirchen' },
  ...
  { code: 'amtsgericht-moenchengladbach',  name: 'Amtsgericht Mönchengladbach',   state: 'NW', city: 'Mönchengladbach' },
  ...
  { code: 'amtsgericht-bad-kreuznach',     name: 'Amtsgericht Bad Kreuznach',     state: 'RP', city: 'Bad Kreuznach' },
  { code: 'amtsgericht-kaiserslautern',    name: 'Amtsgericht Kaiserslautern',    state: 'RP', city: 'Kaiserslautern' },
  { code: 'amtsgericht-koblenz',           name: 'Amtsgericht Koblenz',           state: 'RP', city: 'Koblenz' },
  { code: 'amtsgericht-ludwigshafen',      name: 'Amtsgericht Ludwigshafen am Rhein', state: 'RP', city: 'Ludwigshafen am Rhein' },
  ...
  { code: 'amtsgericht-zweibruecken',      name: 'Amtsgericht Zweibrücken',       state: 'RP', city: 'Zweibrücken' },

  // Saarland (1 Registergericht)
  { code: 'amtsgericht-saarbruecken',      name: 'Amtsgericht Saarbrücken',       state: 'SL', city: 'Saarbrücken' },
  ...
  { code: 'amtsgericht-halle-saale',       name: 'Amtsgericht Halle (Saale)',     state: 'ST', city: 'Halle (Saale)' },
  ...
  { code: 'amtsgericht-neumuenster',       name: 'Amtsgericht Neumünster',        state: 'SH', city: 'Neumünster' },
  ...
  { code: 'amtsgericht-muehlhausen',       name: 'Amtsgericht Mühlhausen',        state: 'TH', city: 'Mühlhausen' },

  // Additional Niedersachsen entries (register competence spread)
  { code: 'amtsgericht-verden',            name: 'Amtsgericht Verden (Aller)',    state: 'NI', city: 'Verden (Aller)' },
  { code: 'amtsgericht-nordhorn',          name: 'Amtsgericht Nordhorn',          state: 'NI', city: 'Nordhorn' },

  // Additional Bayern entries
  { code: 'amtsgericht-aschaffenburg',     name: 'Amtsgericht Aschaffenburg',     state: 'BY', city: 'Aschaffenburg' },
  ...
  { code: 'amtsgericht-deggendorf',        name: 'Amtsgericht Deggendorf',        state: 'BY', city: 'Deggendorf' },
  { code: 'amtsgericht-fuerth',            name: 'Amtsgericht Fürth',             state: 'BY', city: 'Fürth' },
  { code: 'amtsgericht-kempten',           name: 'Amtsgericht Kempten (Allgäu)',  state: 'BY', city: 'Kempten (Allgäu)' },
  ...
  { code: 'amtsgericht-schweinfurt',       name: 'Amtsgericht Schweinfurt',       state: 'BY', city: 'Schweinfurt' },
  { code: 'amtsgericht-straubing',         name: 'Amtsgericht Straubing',         state: 'BY', city: 'Straubing' },
  { code: 'amtsgericht-traunstein',        name: 'Amtsgericht Traunstein',        state: 'BY', city: 'Traunstein' },
  { code: 'amtsgericht-weiden',            name: 'Amtsgericht Weiden i.d.OPf.',   state: 'BY', city: 'Weiden in der Oberpfalz' },
  ...
  { code: 'amtsgericht-ravensburg',        name: 'Amtsgericht Ravensburg',        state: 'BW', city: 'Ravensburg' },
  ...
  { code: 'amtsgericht-leverkusen',        name: 'Amtsgericht Leverkusen',        state: 'NW', city: 'Leverkusen' },
  { code: 'amtsgericht-muelheim-ruhr',     name: 'Amtsgericht Mülheim an der Ruhr', state: 'NW', city: 'Mülheim an der Ruhr' },
  { code: 'amtsgericht-neuss',             name: 'Amtsgericht Neuss',             state: 'NW', city: 'Neuss' },
  { code: 'amtsgericht-oberhausen',        name: 'Amtsgericht Oberhausen',        state: 'NW', city: 'Oberhausen' },
  { code: 'amtsgericht-recklinghausen',    name: 'Amtsgericht Recklinghausen',    state: 'NW', city: 'Recklinghausen' },
  { code: 'amtsgericht-solingen',          name: 'Amtsgericht Solingen',          state: 'NW', city: 'Solingen' },

  // Additional Hessen
  { code: 'amtsgericht-bad-homburg',       name: 'Amtsgericht Bad Homburg v.d.H.', state: 'HE', city: 'Bad Homburg vor der Höhe' },
  { code: 'amtsgericht-offenbach',         name: 'Amtsgericht Offenbach am Main', state: 'HE', city: 'Offenbach am Main' },

  // Additional Schleswig-Holstein
  { code: 'amtsgericht-meldorf',           name: 'Amtsgericht Meldorf',           state: 'SH', city: 'Meldorf' },
  { code: 'amtsgericht-norderstedt',       name: 'Amtsgericht Norderstedt',       state: 'SH', city: 'Norderstedt' },
  ...
  { code: 'amtsgericht-heidelberg',        name: 'Amtsgericht Heidelberg',        state: 'BW', city: 'Heidelberg' },
