...
-- This returns the schema to the post-worker-base state (nullable workerId,
-- unique index, no FK), from which 20260705160000_worker_base_additive/down.sql
-- can further reverse the additive step. No Contractor row is touched destructively.
--
