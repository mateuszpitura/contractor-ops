...
function _getPinningStyles<TData>(column: Column<TData>): CSSProperties {
...
function DataGridTableFillCol() {
  ...
  return <col data-slot="data-grid-table-fill-col" />;
}
...
function DataGridTableFillHeadCell() {
  ...
  return <th data-slot="data-grid-table-fill-head-cell" className="p-0" />;
}
...
function DataGridTableFillBodyCell() {
  ...
  return <td aria-hidden="true" data-slot="data-grid-table-fill-body-cell" className="p-0" />;
}
...
function DataGridTableFillFootCell() {
  ...
  return (
    <td aria-hidden="true" data-slot="data-grid-table-fill-foot-cell" className="border-t p-0" />
  );
}
...
function DataGridTableResizeIndicator({
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-y-0 z-20">
      <div className="bg-primary/85 absolute inset-y-0 left-0 w-px -translate-x-1/2" />
      <div className="bg-primary absolute top-0 left-0 -translate-x-1/2 rounded-b-sm shadow-xs" />
    </div>
  );
}
