...
declare module '@tanstack/react-table' {
  ...
  interface ColumnMeta<TData extends RowData, TValue> {
    ...
    /** Project-local: viewport min-width below which the column is hidden. */
    hideBelow?: number;
  }
}
...
function DataGridProvider<TData extends object>({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: enumerating individual props.* keeps the memo stable during column-resize state changes that are intentionally excluded; listing `props` itself would defeat that and would also be reported as too-broad
  const value = useMemo(
    () => ({
      props,
      table,
