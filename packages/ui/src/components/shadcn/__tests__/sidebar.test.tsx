...
vi.mock('@contractor-ops/ui/hooks/use-mobile', () => ({
  useIsMobile: () => false,
}));
...
describe('SidebarInset', () => {
  it('sets data-slot on the inset wrapper', () => {
    renderSidebar();
    const inset = document.querySelector("[data-slot='sidebar-inset']");
    expect(inset).toBeInTheDocument();
    // The current `SidebarInset` renders a <div>; the legacy assertion
    // expected <main>. Track the component's actual tag instead of pinning
    // a stale element type — landmark semantics for "main" live on the
    // page-level layout, not inside the sidebar primitive.
