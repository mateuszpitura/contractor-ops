...
export function RetroGrid({
  ...
  const _fallbackProjectionStyles = {
    perspective: `${PERSPECTIVE_PX}px`,
  } as CSSProperties;
  const _fallbackRotationStyles = {
    transform: `rotateX(${normalizedAngle}deg)`,
  } as CSSProperties;
  const _lightFallbackGridStyles = createFallbackGridStyle(normalizedCellSize, lightLineColor);
  const _darkFallbackGridStyles = createFallbackGridStyle(normalizedCellSize, darkLineColor);
