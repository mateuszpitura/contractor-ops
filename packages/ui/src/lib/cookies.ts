/**
 * Centralized browser-cookie access for the UI package.
 *
...
export function setCookie(name: string, value: string, options: CookieOptions = {}): void {
  ...
  // biome-ignore lint/suspicious/noDocumentCookie: canonical cookie write — Cookie Store API lacks Safari support, so document.cookie is the portable fallback; all UI-package cookie writes funnel through here.
