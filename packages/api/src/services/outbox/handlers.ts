...
import type { OutboxEventType, OutboxHandler, OutboxHandlerContext } from './handler-types';
import {
  handleHrisClassificationOutcomePush,
  handleHrisInvoicePaidPush,
  handleHrisPaymentStatusPush,
} from './hris-push';
...
const outboxHandlerRegistry: OutboxHandlerRegistry = {
  ...
  'hris.invoice-paid.push': handleHrisInvoicePaidPush,
  'hris.payment-status.push': handleHrisPaymentStatusPush,
  'hris.classification-outcome.push': handleHrisClassificationOutcomePush,
};
