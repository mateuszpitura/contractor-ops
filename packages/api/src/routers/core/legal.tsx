...
// burst this allocated ~30-150 MB per request and OOM'd the pod. The
// mutation now enqueues an async export — the consumer at `/exports/_process`
// renders + uploads + emails a download link.
//
// Security contract (ASVS V4 Access Control):
