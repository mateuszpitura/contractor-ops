/**
 * Portal documents — route shell with inlined page content.
 */

import { DocumentsIllustration, SectionLabel } from '@contractor-ops/ui';
...
import { usePortalDocuments } from '../../components/portal/hooks/use-portal-documents.js';
...
function PortalDocumentsPageContent() {
