/**
 * Portal contract detail — route shell with inlined page content.
 */
    ...
    () => [
      {
        ...
        header: () => rateLabel,
        cell: ({ row }) =>
          formatMoneyAmount(row.original.rateValueMinor, row.original.currency, 'en-US'),
      },
      {
        id: 'type',
        header: () => typeLabel,
...
export default function PortalContractDetailPage() {
  return (
    <Suspense fallback={<PageLoadingSpinner />}>
      <PortalContractDetailPageContent />
    </Suspense>
  );
}
