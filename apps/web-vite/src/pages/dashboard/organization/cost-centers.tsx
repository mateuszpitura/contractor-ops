...
import { CostCenterCsvImportDialogWired } from '../../../components/organization/cost-centers/cost-center-csv-import-dialog.js';
import { CostCenterFormSheetWired } from '../../../components/organization/cost-centers/cost-center-form-sheet.js';
import { CostCenterTable } from '../../../components/organization/cost-centers/data-table.js';
import { useOrganizationCostCenters } from '../../../components/organization/hooks/use-organization-cost-centers.js';
...
function OrganizationCostCentersPageContent() {
  ...
  return (
    <OrganizationLayout>
      <section className="flex min-h-0 flex-1 flex-col gap-4">
        ...
        />
        <CostCenterFormSheetWired
          open={sheetOpen}
          onOpenChange={setSheetOpen}
          costCenter={editing}
        />
        <CostCenterCsvImportDialogWired open={csvOpen} onOpenChange={setCsvOpen} />
      </section>
    </OrganizationLayout>
  );
}

export default function OrganizationCostCentersPage() {
  return <OrganizationCostCentersPageContent />;
}
