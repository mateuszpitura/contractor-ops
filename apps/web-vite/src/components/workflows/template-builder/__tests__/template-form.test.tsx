/**
 * PORTED STUB — apps/web/src/components/workflows/template-builder/__tests__/template-form.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] template-form', () => {
