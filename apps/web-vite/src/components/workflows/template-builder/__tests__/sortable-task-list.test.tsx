/**
 * PORTED STUB — apps/web/src/components/workflows/template-builder/__tests__/sortable-task-list.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] sortable-task-list', () => {
