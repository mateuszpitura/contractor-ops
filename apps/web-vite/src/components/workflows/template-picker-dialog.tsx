...
const TemplatePickerItem = memo(function TemplatePickerItem({
  template,
  isSelected,
  onSelect,
  t,
  ...
  const handleClick = useCallback(() => onSelect(template.id), [onSelect, template.id]);
...
export function TemplatePicker({
  ...
  const handleClearTypeFilter = useCallback(() => setTypeFilter(null), [setTypeFilter]);
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[480px]">
        ...
        <DialogFooter>
          ...
          <Button onClick={handleStartClick} disabled={!canStart || startRunMutation.isPending}>
