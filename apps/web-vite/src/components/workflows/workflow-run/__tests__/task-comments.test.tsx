/**
 * PORTED STUB — apps/web/src/components/workflows/workflow-run/__tests__/task-comments.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] task-comments', () => {
