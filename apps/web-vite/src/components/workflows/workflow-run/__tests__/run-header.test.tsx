/**
 * PORTED STUB — apps/web/src/components/workflows/workflow-run/__tests__/run-header.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] run-header', () => {
