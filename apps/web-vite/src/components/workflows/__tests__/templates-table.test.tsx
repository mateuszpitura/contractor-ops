/**
 * PORTED STUB — apps/web/src/components/workflows/__tests__/templates-table.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] templates-table', () => {
