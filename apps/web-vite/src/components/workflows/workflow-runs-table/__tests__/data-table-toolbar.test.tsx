...
describe('DataTableToolbar', () => {
  it('renders search input and start workflow button', () => {
    render(<DataTableToolbar search="" onSearchChange={vi.fn()} onStartWorkflow={vi.fn()} />);
  ...
  it('calls onStartWorkflow when button is clicked', async () => {
    ...
    const { user } = setup(
      <DataTableToolbar search="" onSearchChange={vi.fn()} onStartWorkflow={onStartWorkflow} />,
    );
  ...
  it('displays current search value', () => {
    render(
      <DataTableToolbar search="onboarding" onSearchChange={vi.fn()} onStartWorkflow={vi.fn()} />,
    );
