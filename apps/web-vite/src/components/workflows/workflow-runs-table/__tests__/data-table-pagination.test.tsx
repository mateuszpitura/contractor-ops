/**
 * PORTED STUB — apps/web/src/components/workflows/workflow-runs-table/__tests__/data-table-pagination.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] data-table-pagination', () => {
