/**
 * Minimal render helper for web-vite idp component tests — mirror of the
 * offboarding/__tests__/_render.tsx helper. Self-contained per domain so the
 * test glob picks up only `.test.{ts,tsx}` (this `_render.tsx` is ignored).
 */
