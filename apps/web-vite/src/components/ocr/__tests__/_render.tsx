/**
 * Per-domain mount helper for web-vite OCR component tests — mirror of
 * sibling helpers under `consent/__tests__/_render.tsx` and
 * `workflows/__tests__/_render.tsx`. Kept per-domain so each `__tests__`
