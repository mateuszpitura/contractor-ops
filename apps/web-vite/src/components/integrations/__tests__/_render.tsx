/**
 * Minimal render helper for web-vite integrations component tests —
 * mirror of `notifications/__tests__/_render.tsx`. Self-contained per
 * domain; the include glob picks up only `.test.{ts,tsx}` so this file
 * is ignored.
 */
