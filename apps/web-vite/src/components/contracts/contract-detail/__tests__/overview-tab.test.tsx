/**
 * PORTED STUB — apps/web/src/components/contracts/contract-detail/__tests__/overview-tab.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] overview-tab', () => {
