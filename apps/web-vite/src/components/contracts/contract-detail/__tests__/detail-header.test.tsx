/**
 * PORTED STUB — apps/web/src/components/contracts/contract-detail/__tests__/detail-header.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] detail-header', () => {
