/**
 * PORTED STUB — apps/web/src/components/contracts/contract-detail/__tests__/signing-progress-bar.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] signing-progress-bar', () => {
