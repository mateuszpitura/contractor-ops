/**
 * PORTED STUB — apps/web/src/components/contracts/contract-table/__tests__/data-table-bulk-actions.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] data-table-bulk-actions', () => {
