/**
 * PORTED STUB — apps/web/src/components/contracts/contract-wizard/__tests__/step-details.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] step-details', () => {
