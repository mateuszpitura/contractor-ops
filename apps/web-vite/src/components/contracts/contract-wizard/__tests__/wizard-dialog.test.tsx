/**
 * PORTED STUB — apps/web/src/components/contracts/contract-wizard/__tests__/wizard-dialog.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] wizard-dialog', () => {
