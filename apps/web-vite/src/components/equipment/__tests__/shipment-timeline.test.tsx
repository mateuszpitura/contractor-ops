/**
 * PORTED STUB — apps/web/src/components/equipment/__tests__/shipment-timeline.test.tsx migrated as deferred skip-stub.
 *
...
describe.skip('[DEFERRED — component missing] shipment-timeline', () => {
  // noop
});
