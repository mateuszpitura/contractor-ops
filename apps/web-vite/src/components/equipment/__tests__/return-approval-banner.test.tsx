/**
 * PORTED STUB — apps/web/src/components/equipment/__tests__/return-approval-banner.test.tsx migrated as deferred skip-stub.
 *
...
describe.skip('[DEFERRED — component missing] return-approval-banner', () => {
  // noop
});
