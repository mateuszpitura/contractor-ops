...
import type { UpdatableStatus } from './hooks/use-shipment-timeline.js';
import { UPDATABLE_STATUSES, useShipmentTimeline } from './hooks/use-shipment-timeline.js';
...
export function ShipmentTimeline({ shipmentId, currentStatus, events }: ShipmentTimelineProps) {
  ...
  const handleAddEvent = useCallback(() => {
    ...
    addEvent({
      shipmentId,
      status: newStatus as UpdatableStatus,
