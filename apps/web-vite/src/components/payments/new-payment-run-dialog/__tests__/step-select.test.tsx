/**
 * PORTED STUB — apps/web/src/components/payments/new-payment-run-dialog/__tests__/step-select.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] step-select', () => {
