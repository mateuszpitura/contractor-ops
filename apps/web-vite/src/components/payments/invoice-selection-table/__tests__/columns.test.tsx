/**
 * PORTED STUB — apps/web/src/components/payments/invoice-selection-table/__tests__/columns.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] columns', () => {
