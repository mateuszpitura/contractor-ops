/**
 * PORTED STUB — apps/web/src/components/payments/invoice-selection-table/__tests__/data-table.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] data-table', () => {
