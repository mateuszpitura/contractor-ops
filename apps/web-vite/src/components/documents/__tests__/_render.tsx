/**
 * Minimal render helper for web-vite documents component tests — mirror of
 * the sibling helpers under other `__tests__` folders. Kept per-domain so
 * each folder is self-contained and the include glob picks up only
 * `.test.{ts,tsx}` files.
 */
