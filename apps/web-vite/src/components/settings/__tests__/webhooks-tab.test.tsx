...
import type { WebhooksTabViewProps } from '../webhooks-tab';
import { WebhooksTabView } from '../webhooks-tab';
...
describe('WebhooksTabView', () => {
  ...
  it('renders the subscription table with the supplied rows', () => {
    render(
      <WebhooksTabView {...buildProps({ subscriptions: [sampleSub] as unknown as SubList })} />,
    );
