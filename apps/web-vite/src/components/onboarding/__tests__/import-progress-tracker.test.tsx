/**
 * PORTED STUB — apps/web/src/components/onboarding/__tests__/import-progress-tracker.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] import-progress-tracker', () => {
