/**
 * PORTED STUB — apps/web/src/components/onboarding/__tests__/source-selection-step.test.tsx migrated as a deferred skip-stub.
 *
...
describe.skip('[DEFERRED] source-selection-step', () => {
