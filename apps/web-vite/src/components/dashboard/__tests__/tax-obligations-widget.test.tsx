/**
 * PORTED STUB — apps/web/src/components/dashboard/__tests__/tax-obligations-widget.test.tsx migrated as deferred skip-stub.
 *
...
describe.skip('[DEFERRED — component missing] tax-obligations-widget', () => {
  // noop
});
