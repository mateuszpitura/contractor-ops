/**
 * PORTED STUB — apps/web/src/components/dashboard/__tests__/deadlines-widget.test.tsx migrated as deferred skip-stub.
 *
...
describe.skip('[DEFERRED — component missing] deadlines-widget', () => {
  // noop
});
