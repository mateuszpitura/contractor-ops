/**
 * PORTED STUB — apps/web/src/components/dashboard/__tests__/approval-queue-widget.test.tsx migrated as deferred skip-stub.
 *
...
describe.skip('[DEFERRED — component missing] approval-queue-widget', () => {
  // noop
});
