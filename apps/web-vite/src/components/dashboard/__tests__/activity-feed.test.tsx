/**
 * PORTED STUB — apps/web/src/components/dashboard/__tests__/activity-feed.test.tsx migrated as deferred skip-stub.
 *
...
describe.skip('[DEFERRED — component missing] activity-feed', () => {
  // noop
});
