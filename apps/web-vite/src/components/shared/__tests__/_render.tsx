 ...
 * sibling helper under `workflows/__tests__/_render.tsx`. Kept per-domain
 * so each `__tests__` folder is self-contained and the include glob picks
 * up only `.test.{ts,tsx}` files (this `_render.tsx` is ignored).
 */
