...
import { StatusfeststellungsverfahrenPanelContainer } from './classification/drv-clearance/drv-clearance-panel.js';
...
import { Ir35ChainPanelContainer } from './ir35-chain/ir35-chain-panel.js';
import { OtherClientAttestationForm } from './other-client-attestation/other-client-attestation-form.js';
    ...
    <div className="flex flex-col gap-6 py-4">
      ...
      {countryCode === 'DE' ? (
        <>
          ...
          <OtherClientAttestationForm engagementId={engagementId} />
        </>
      ) : null}
    </div>
  );
...
/** @deprecated Use EngagementDetail */
export { EngagementDetailContainer as EngagementDetail };
