  ...
  const activeReport = (() => {
    switch (report) {
      ...
      case "expiring-contracts":
        return (
          <ExpiringContractsReport dateFrom={dateFrom} dateTo={dateTo} />
        );
      case "overdue-invoices":
        return (
          <OverdueInvoicesReport dateFrom={dateFrom} dateTo={dateTo} />
        );
      case "compliance-gaps":
        return (
          <ComplianceGapsReport dateFrom={dateFrom} dateTo={dateTo} />
        );
      default:
        return <SpendContractorReport dateFrom={dateFrom} dateTo={dateTo} />;
    }
