...
const mockTasks = [
  {
    id: "t1", title: "Task 1", description: null, taskType: "MANUAL",
    status: "DONE", required: true, assigneeUserId: null, assigneeRole: null,
    dueAt: null, completedAt: "2026-03-01", completedByUserId: "u1",
    startedAt: null, dependsOnTaskRunId: null, resultJson: null,
    isOverdue: false, createdAt: "2026-02-01",
  },
  {
    id: "t2", title: "Task 2", description: null, taskType: "APPROVAL",
    status: "TODO", required: false, assigneeUserId: "u1", assigneeRole: null,
    dueAt: null, completedAt: null, completedByUserId: null,
    startedAt: null, dependsOnTaskRunId: null, resultJson: null,
    isOverdue: false, createdAt: "2026-02-01",
  },
];
...
describe("TaskChecklist", () => {
  ...
  it("applies opacity to condition-skipped tasks", () => {
    ...
    render(
      <TaskChecklist tasks={[skippedTask]} runId="run-1" currentUserId="u1" />,
    );
