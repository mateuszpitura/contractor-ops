    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-1">
          <h3 className="text-sm font-semibold text-destructive">OCR credits exhausted</h3>
          <p className="text-sm text-muted-foreground">
            You have used all OCR credits this month. Upgrade your plan for more credits or purchase
            a top-up bundle.
          </p>
        </div>
      </div>
