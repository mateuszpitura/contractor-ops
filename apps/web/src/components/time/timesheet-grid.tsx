...
/**
 * Weekly timesheet grid per UI-SPEC TimesheetGrid (D-01, D-02).
 *
 * Card container with project rows (from active contracts) and Mon-Sun columns.
 * Each cell is an editable hours input. Grand total row at bottom.
 * Imported entries (source !== MANUAL) show muted background and are non-editable.
 * Auto-save on cell blur via onSave callback.
 */
