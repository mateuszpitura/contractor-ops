...
import { ChainParticipantRow } from '@/components/contractors/ir35-chain/chain-participant-row';
import type { Ir35ChainParticipantRow } from '@/components/contractors/ir35-chain/ir35-chain-panel';
...
describe('ChainParticipantRow', () => {
  ...
  it('shows a formatted date when sdsDeliveredAt is set', () => {
    ...
    // next-intl medium dateStyle renders something like "Mar 10, 2026"
