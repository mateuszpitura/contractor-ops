// ---------------------------------------------------------------------------
// Phase 60 · Plan 04 · CLASS-10 — ActiveAlertsTile
// ---------------------------------------------------------------------------
//
// GB: single count of open/acknowledged reassessment triggers.
// DE: two chips for economic-dependency bands + DRV clearances expiring ≤90d.
