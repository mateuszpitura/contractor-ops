// ---------------------------------------------------------------------------
// Phase 60 · Plan 04 · CLASS-10 — RiskDistributionTile
// ---------------------------------------------------------------------------
//
// Native-flex stacked-bar visualisation of the three-bucket risk distribution
// (safe / warning / critical). Intentionally does NOT import any external
// data-visualisation library — UI-SPEC Registry Safety requires shadcn-only.
//
// Accessibility:
//   - role='img' + aria-label summarising counts and percentages so screen
//     readers receive the same information a sighted user gets from colour.
//   - semantic triad — colour (OKLCh tokens) + bucket label + numeric
//     percentage tooltip — never colour-alone per WCAG 1.4.1.
//   - each segment is a keyboard-focusable tooltip trigger.
