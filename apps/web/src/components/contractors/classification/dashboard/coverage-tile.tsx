// ---------------------------------------------------------------------------
// Phase 60 · Plan 04 · CLASS-10 — CoverageTile
// ---------------------------------------------------------------------------
//
// Shows `completed / total` active engagements for a market. Renders a KPI
// numeral + progress bar. Accent-positive when coverage ≥ 80%.
