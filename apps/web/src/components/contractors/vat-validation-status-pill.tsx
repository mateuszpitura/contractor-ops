...
// ---------------------------------------------------------------------------
//
// Visual state of a contractor's most recent HMRC/VIES validation result.
// Renders a shadcn `Badge` + lucide-react icon + label; WCAG-AA (icon + text,
// never colour alone). Consumers pass the denormalised fields from the
// `contractor` table (`latestVatValidationStatus`, `latestVatValidatedAt`) —
// Plan 57-03 orchestrator keeps these in sync with `TaxIdValidation` rows.
// ---------------------------------------------------------------------------
