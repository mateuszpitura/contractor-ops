          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <span className="font-mono font-semibold">
                {formatMoney(certificate.grossAmountMinor, certificate.currency)}
              </span>
              ...
              <span className="font-mono font-semibold">
                {formatMoney(certificate.whtAmountMinor, certificate.currency)}
              </span>
              <span className="text-muted-foreground">Net Paid</span>
              <span className="font-mono font-bold">
                {formatMoney(certificate.netAmountMinor, certificate.currency)}
              </span>
            </div>
