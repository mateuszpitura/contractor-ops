...
export function SlackBrandIcon({ className }: BrandIconProps) {
  return <SiSlack className={cn(base, "text-[#611f69]", className)} aria-hidden />;
}

/** Jira Software — brand blue. */
export function JiraBrandIcon({ className }: BrandIconProps) {
  return <SiJira className={cn(base, "text-[#0052CC]", className)} aria-hidden />;
}
...
export function GoogleCalendarBrandIcon({ className }: BrandIconProps) {
  return <SiGooglecalendar className={cn(base, "text-[#4285F4]", className)} aria-hidden />;
}

export function NotionBrandIcon({ className }: BrandIconProps) {
  return <SiNotion className={cn(base, "text-foreground", className)} aria-hidden />;
}

export function ConfluenceBrandIcon({ className }: BrandIconProps) {
  return <SiConfluence className={cn(base, "text-[#172B4D]", className)} aria-hidden />;
}

/** Microsoft Outlook — Phosphor. */
export function OutlookCalendarBrandIcon({ className }: BrandIconProps) {
  return <PiMicrosoftOutlookLogo className={cn(base, "text-[#0078D4]", className)} aria-hidden />;
}
