...
describe("DirectorySummaryBar", () => {
  it("renders total, existing, and new counts", () => {
    render(<DirectorySummaryBar total={50} alreadyImported={20} newUsers={30} selected={0} />);
  ...
  it("renders selected count when > 0", () => {
    render(<DirectorySummaryBar total={50} alreadyImported={20} newUsers={30} selected={10} />);
