...
import { A, H1, H2, H3, Li, Ol, P, Strong, Ul } from '@/components/legal/privacy-prose';

// Minimal renderer for Payload Lexical serialized JSON over the subset of
// node types the legal-documents catalog uses. Keeps apps/web free of any
// hard dep on @payloadcms/richtext-lexical — payload is at apps/cms only.
