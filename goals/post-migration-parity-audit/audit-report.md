...
| Area | P0 | P1 | P2 |
|------|----|----|----|
| PAGE | **1 / 0 / 0** (GAP-LEGAL-CLUSTER-001 escalated) | 5 / 0 / 0 | 4 / 1 / 0 (GAP-PAGE-008 inline-fixed) |
| ROUTE | 0 / 0 / 0 | 4 / 0 / 0 | 2 / 0 / 0 |
| WEBHOOK | 0 / 1 / 0 (GAP-WEBHOOK-003 escalated → inline-fixed) | 1 / 0 / 0 | 0 / 0 / 0 |
| MIDDLEWARE | 0 / 0 / 0 | 2 / 1 / 0 (GAP-MIDDLEWARE-007 inline-fixed) | 3 / 1 / 0 (GAP-MIDDLEWARE-004 inline-fixed under sibling commit `a511f9d4` — see row note) |
...
| SECURITY | **2 / 1 / 0** (2 escalated — see GAP-SECURITY-001, -002; -003 inline-fixed) | 0 / 2 / 0 (GAP-SECURITY-005 + GAP-SECURITY-008 inline-fixed; GAP-SECURITY-004 closed-verified-intentional — see row) | 2 / 0 / 0 |
...
| **Total** | **7 / 4 / 0** | **24 / 7 / 0** (+1 closed-verified: GAP-SECURITY-004) | **29 / 6 / 0** |
