...
| SECURITY | **2 / 1 / 0** (2 escalated — see GAP-SECURITY-001, -002; -003 inline-fixed) | 1 / 1 / 0 (GAP-SECURITY-005 inline-fixed; GAP-SECURITY-004 closed-verified-intentional — see row) | 2 / 0 / 0 |
...
| **Total** | **7 / 4 / 0** | **25 / 6 / 0** (+1 closed-verified: GAP-SECURITY-004) | **29 / 6 / 0** |
