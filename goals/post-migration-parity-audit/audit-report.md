...
| MIDDLEWARE | 0 / 0 / 0 | 3 / 0 / 0 | 3 / 1 / 0 (GAP-MIDDLEWARE-004 inline-fixed under sibling commit `a511f9d4` — see row note) |
...
| **Total** | **7 / 4 / 0** | **26 / 5 / 0** (+1 closed-verified: GAP-SECURITY-004) | **30 / 5 / 0** |
