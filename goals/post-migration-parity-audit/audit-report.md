...
| ROUTE | 0 / 0 / 0 | 4 / 0 / 0 | 1 / 1 / 0 (GAP-ROUTE-001 inline-fixed) |
| WEBHOOK | 0 / 1 / 0 (GAP-WEBHOOK-003 escalated → inline-fixed) | 1 / 0 / 0 | 0 / 0 / 0 |
| MIDDLEWARE | 0 / 0 / 0 | 1 / 2 / 0 (GAP-MIDDLEWARE-005 + GAP-MIDDLEWARE-007 inline-fixed) | 2 / 2 / 0 (GAP-MIDDLEWARE-004 inline-fixed under sibling commit `a511f9d4` — see row note; GAP-MIDDLEWARE-006 inline-fixed) |
...
| **Total** | **7 / 4 / 0** | **23 / 8 / 0** (+1 closed-verified: GAP-SECURITY-004) | **24 / 10 / 0** (+1 closed-verified: GAP-SECURITY-007) |
