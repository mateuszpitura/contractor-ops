...
| MIDDLEWARE | 0 / 0 / 0 | 2 / 1 / 0 (GAP-MIDDLEWARE-007 inline-fixed) | 2 / 2 / 0 (GAP-MIDDLEWARE-004 inline-fixed under sibling commit `a511f9d4` — see row note; GAP-MIDDLEWARE-006 inline-fixed) |
...
| **Total** | **7 / 4 / 0** | **24 / 7 / 0** (+1 closed-verified: GAP-SECURITY-004) | **27 / 7 / 0** (+1 closed-verified: GAP-SECURITY-007) |
