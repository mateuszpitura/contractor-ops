...
- [x] **Phase 92: Theme B — Leave Management + KP-Grade Time Tracking** - per-market leave-balance engine, request workflow, team calendar, employee time + working-time alerts + ewidencja report (completed 2026-07-05)
...
- [x] **Phase 101: Theme C — Marketplace Listings + Dev Experience** - Zapier / n8n / Make listings + status dashboard, dev portal, Postman/Insomnia, public status page, sandbox tier (completed 2026-07-16)
...
- [x] 92-01-PLAN.md — Wave-0 RED test scaffolds (all VALIDATION.md files) + shared employee/holiday fixtures [wave 1]
...
- [x] 92-06-PLAN.md — [BLOCKING] Prisma push/generate + ewidencja migration apply (per-region human gate) [wave 2]
- [x] 92-07-PLAN.md — Leave-balance service + approval-chain LEAVE_REQUEST seams + cross-org leak GREEN [wave 3]
- [x] 92-08-PLAN.md — WT-limit sync check + ewidencja-builder (INSERT-only) + ewidencja-immutable DB GREEN [wave 3]
- [x] 92-09-PLAN.md — Leave router (submit/sick-direct/CRUD/blackout + team-calendar read) [wave 4]
- [x] 92-10-PLAN.md — WT-limit daily scan (region fan-out + digest) + cron sub-job [wave 4]
- [x] 92-11-PLAN.md — Employee-time + ewidencja routers + mount all three + flag-off GREEN [wave 5]
- [x] 92-12-PLAN.md — S1 leave queue + balance card + all i18n namespaces (en/de/pl/ar) [wave 6]
- [x] 92-13-PLAN.md — S2 team calendar (new build) + team-calendar test GREEN [wave 7]
- [x] 92-14-PLAN.md — S3 employee time entry + S5 WT-limit banner [wave 7]
- [x] 92-15-PLAN.md — S4 ewidencja report + immutable/supersede-chain treatment [wave 7]
- [x] 92-16-PLAN.md — Documentation-follows-code: leave+time wiki + MEMORY invariants + check:wiki-brain [wave 8]
...
| 92. Theme B — Leave + KP-Grade Time Tracking | v7.0 | 12/16 | Complete    | 2026-07-05 |
