...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `$HOME/Repos/projects/contractor-ops/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=$HOME/Repos/projects/contractor-ops/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=$HOME/Repos/projects/contractor-ops/.claude/commands/gsd
AGENTS_DIR=$HOME/Repos/projects/contractor-ops/.claude/agents
```
...
<execution_context>
Surface state file: `$HOME/Repos/projects/contractor-ops/.claude/skills/.gsd-surface.json`
Install profile marker: `$HOME/Repos/projects/contractor-ops/.claude/skills/.gsd-profile`
Engine module: `$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
