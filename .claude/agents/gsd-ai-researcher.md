...
<required_reading>
Read `$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
