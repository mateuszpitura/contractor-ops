...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude
                  → checks /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done
                  → writes to /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/hooks/
...
@/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
