...
<required_reading>
@$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = $HOME/Repos/projects/contractor-ops/.claude
                  → checks $HOME/Repos/projects/contractor-ops/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = $HOME/Repos/projects/contractor-ops/.claude/get-shit-done
                  → writes to $HOME/Repos/projects/contractor-ops/.claude/get-shit-done/hooks/
...
@$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/references/common-bug-patterns.md
