...
Use template from `$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/templates/UI-SPEC.md`
