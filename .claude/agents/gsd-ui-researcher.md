...
Use template from `/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
