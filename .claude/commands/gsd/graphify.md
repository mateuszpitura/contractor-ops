...
Knowledge graph is disabled. To activate:
  ...
  node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
