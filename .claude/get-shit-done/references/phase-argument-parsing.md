...
```bash
PHASE_INFO=$(node "/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
