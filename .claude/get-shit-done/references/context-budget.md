...
The keys live in `.claude/settings.json` (project) or `/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/settings.json` (global) — **not** in `.planning/config.json`:
