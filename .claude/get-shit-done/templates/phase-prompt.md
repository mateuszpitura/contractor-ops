...
<!-- For checkpoint task examples and patterns, see @$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/references/checkpoints.md -->
...
See `$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
