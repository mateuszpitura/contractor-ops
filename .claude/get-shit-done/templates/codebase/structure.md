...
- Usage: Reference from command with `@$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to $HOME/Repos/projects/contractor-ops/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to $HOME/Repos/projects/contractor-ops/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
