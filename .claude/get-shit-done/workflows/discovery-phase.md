...
See $HOME/Repos/projects/contractor-ops/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $HOME/Repos/projects/contractor-ops/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using $HOME/Repos/projects/contractor-ops/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $HOME/Repos/projects/contractor-ops/.claude/get-shit-done/templates/discovery.md
...
Use $HOME/Repos/projects/contractor-ops/.claude/get-shit-done/templates/discovery.md.
