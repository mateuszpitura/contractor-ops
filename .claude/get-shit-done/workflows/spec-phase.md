...
```bash
INIT=$(node "$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/templates/spec.md.
