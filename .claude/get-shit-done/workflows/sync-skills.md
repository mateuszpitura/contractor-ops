...
INSTALL_JS_GLOBAL="/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
