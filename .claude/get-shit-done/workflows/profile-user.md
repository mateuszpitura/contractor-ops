...
```bash
PROFILE_PATH="/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.md" "/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
SCAN_RESULT=$(node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```
...
```bash
BACKUP_PATH="/Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Users/mateusz.pitura/Repos/projects/contractor-ops/.claude/CLAUDE.md
```
