...
Key references:
- @$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @$HOME/Repos/projects/contractor-ops/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.md" "$HOME/Repos/projects/contractor-ops/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at $HOME/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to $HOME/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to $HOME/Repos/projects/contractor-ops/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at $HOME/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at $HOME/Repos/projects/contractor-ops/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to $HOME/Repos/projects/contractor-ops/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="$HOME/Repos/projects/contractor-ops/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    $HOME/Repos/projects/contractor-ops/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   $HOME/Repos/projects/contractor-ops/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        $HOME/Repos/projects/contractor-ops/.claude/CLAUDE.md
```
