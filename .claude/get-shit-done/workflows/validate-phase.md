...
```
Agent(
  prompt="Read $HOME/Repos/projects/contractor-ops/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `$HOME/Repos/projects/contractor-ops/.claude/get-shit-done/templates/VALIDATION.md`
