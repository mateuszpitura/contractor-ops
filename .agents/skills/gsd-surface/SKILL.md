...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `$HOME/Repos/projects/contractor-ops/.Codex/skills/.gsd-surface.json`
...
```bash
# Codex
RUNTIME_CONFIG_DIR=$HOME/Repos/projects/contractor-ops/.Codex/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=$HOME/Repos/projects/contractor-ops/.Codex/commands/gsd
AGENTS_DIR=$HOME/Repos/projects/contractor-ops/.Codex/agents
```
...
<execution_context>
Surface state file: `$HOME/Repos/projects/contractor-ops/.Codex/skills/.gsd-surface.json`
Install profile marker: `$HOME/Repos/projects/contractor-ops/.Codex/skills/.gsd-profile`
Engine module: `$HOME/Repos/projects/contractor-ops/.Codex/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `$HOME/Repos/projects/contractor-ops/.Codex/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
